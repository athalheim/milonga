var messages = {
    helpTitle:                { es: "Haga clic para mostrar página de ayuda",                                                           en: "Click to display Help Page",                                                fr: "Cliquez pour afficher la page d'aide" },
    styleTitle:               { es: "Seleccionar estilo...",                                                                            en: "Select Style...",                                                           fr: "Sélectionner le style..." },
    ...
    tandasList:               { es: "Arrastre: Artista-Partitura para iniciar/actualizar Tanda / Tanda-Partitura para mover/eliminar.", en: "Drag: Artist-Score to initiate/update Tanda / Tanda-Score to move/remove.", fr: "Glisser: Artiste-Partition pour initier/metter à jour une Tanda / Tanda-Partition pour la déplacer/supprimer." },
    ...
    disabledUntilPlayStopped: { es: "¡Inhabilitada hasta que la milonga haya dejado de jugar!",                                         en: "Disabled until milonga has stopped playing!",                               fr: "Désactivé jusqu'à ce que l'arrêt de la milonga!" },
